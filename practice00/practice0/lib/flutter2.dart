  ...
  Future<void> fetchData() async {
    try {
      ...
      final List<Map<String, dynamic>> fetchedItems = querySnapshot.docs.map((doc) {
        ...
        data['documentId'] = doc.id;  // ドキュメントIDを追加
        return data;
      }).toList();
      setState(() {
        // データをリストにセット
                ...
                child: items.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            title: Text("ドキュメント名: ${items[index]['documentId']}|書名: ${items[index]['title']}|著者名: ${items[index]['name']}|出版社: ${items[index]['publisher']}|価格: ${items[index]['price']}円|ページ数: ${items[index]['page']}ページ|分野: ${items[index]['calc']}", 
